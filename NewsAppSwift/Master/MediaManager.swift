...
extension MediaManager {
    func openCamera(commpletion: ((_ image: UIImage?, _ info: [UIImagePickerController.InfoKey : Any]?) -> ())?) {
        
        takeAPhoto()
        self.commpletion = commpletion
    }
    func openGallery(commpletion: ((_ image: UIImage?, _ info: [UIImagePickerController.InfoKey : Any]?) -> ())?) {

...
struct OnBoardingView: View {
    ...
    var arrOnboarding: [MDLOnboarding] = [
        MDLOnboarding(title: "The best digital magazine.", subTitle: "Start exploring the hottest news topics around the world with us anywhere.", image: "ic_onboarding_1"),
        
        MDLOnboarding(title: "Stay up to date with selected news", subTitle: "Get the latest news selected by editors according to your interests from all over the world.", image: "ic_onboarding_2"),
        
        MDLOnboarding(title: "Enrich your understanding of the world.", subTitle: "The latest and hottest news from around the world, making you understand more about your surroundings.", image: "ic_onboarding_3")
    ]
    ...
    var body: some View {
        VStack {
            ...
            HStack {
                ForEach(0..<arrOnboarding.count, id: \.self) { index in
                    BottomIndicatorView(color: offset == index ? .appGrey : .appGreyLight)
                }
            }
            ...
            AppPrimaryButton(title: offset == (arrOnboarding.count - 1) ? "Done" : "Next", width: 170.aspectRatio) {
            ...
            DragGesture()
                ...
                .onEnded { value in
                    if value.translation.width > 50 && offset > 0 {
                        offset -= 1
                    } else if value.translation.width < -50 && offset < arrOnboarding.count - 1 {
                        offset += 1
                    }
                }
        )
